# Product Requirements Document: Vibe Check Platform (MVP)
...
- **Mục tiêu:** 
    1. Xây dựng nền tảng phỏng vấn mô phỏng (Mock Interview) có khả năng mở rộng đa lĩnh vực với mentor ảo.
    2. Cung cấp phản hồi chuyên môn tức thời (Feedback loop) từ mentor dựa trên đặc thù công việc của từng ngành (Tech, Marketing, Content, v.v.).
...
- **User Stories:**
    ...
    - "Là một Junior, tôi muốn nhận phản biện chuyên sâu từ mentor về các bài giải/sản phẩm của tôi, để tôi hiểu được các lỗ hổng tư duy của mình."
...
### Yêu cầu chức năng:
- **Domain-Based Session:** Người dùng chọn lĩnh vực (Tech, Content, Marketing...) trước khi bắt đầu. Hệ thống sẽ tự nạp câu hỏi và Workspace tương ứng.
- **Flexible Workspace:** 
...
- **Evaluation Engine:** Chấm điểm dựa trên tiêu chí đánh giá chuyên biệt theo từng Domain.
...
- **Latency:** Thời gian phản hồi mentor (streaming) < 2s.
- **Security:** Bảo mật dữ liệu người dùng.
...
- **Giả định:** Người dùng sẵn sàng luyện tập phỏng vấn với một mentor ảo thay vì người thật.
- **Rủi ro:** Đảm bảo chất lượng feedback phải sát với tiêu chí thực tế của từng ngành.
- **Câu hỏi mở:** Làm thế nào để tạo ra các tiêu chí đánh giá chuẩn xác cho những ngành mang tính định tính cao như Content/Marketing? (Giải pháp: Hợp tác hoặc nghiên cứu từ các nguồn tài liệu uy tín của ngành).
