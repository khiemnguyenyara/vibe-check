export const mentorCharacterStyles = {
  root: "w-full h-screen flex items-center justify-center pt-20",
  container: "w-full h-full relative",
  card: "relative w-full h-full flex flex-col items-center justify-center gap-8 p-8 sm:p-12",
  characterImage: "flex-1 flex items-center justify-center max-w-md w-full",
  image: "w-full h-full object-contain",
  content:
    "flex flex-col items-center justify-center gap-6 text-center max-w-2xl",
