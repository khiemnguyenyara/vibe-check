export const homeStyles = {
  root: "relative isolate flex min-h-screen flex-col overflow-hidden bg-background text-foreground",
  heroBackdrop:
    "pointer-events-none absolute inset-x-0 top-0 -z-10 h-[40rem] overflow-hidden bg-gradient-to-br from-violet-300 via-fuchsia-100 to-transparent dark:from-violet-900/60 dark:via-fuchsia-950/30",
  heroOrbLeft:
  ...
  main: "mx-auto flex w-full max-w-5xl flex-col px-3 py-20 sm:px-4",
